...
Файлы **proxy.pac** и **proxy_yt.pac** не пополняются новыми данными в связи с закрытием проекта по выгрузке дампов РКН.  
...
The **proxy.pac** and **proxy_yt.pac** files are not being updated with new data due to the closure of the [RKN](https://en.wikipedia.org/wiki/Roskomnadzor) dump upload project.  
