...
Modified (**antizapret.prostovpn.org**) Proxy Auto Configuration (PAC) files [**_proxy_yt.pac_**](https://github.com/onminonA/proxy.pac#permanent-link-to-the-remote-pac-file-with-youtube-video-stream-proxying-through-your-tunnel) and [**_proxy.pac_**](https://github.com/onminonA/proxy.pac#permanent-link-to-the-remote-pac-file) with redirect to your own local proxy (127.0.0.1:1080).  
